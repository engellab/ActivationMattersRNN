...
def run_mds_and_plot(cfg, attempt, img_name, Mat, img_save_folder, inds_list, legends, colors, hatch, markers, save, show):
    ...
    mds = MDS(n_components=2, dissimilarity='precomputed', n_init=101, eps=1e-6, max_iter=1000, random_state=attempt)
    mds.fit(Mat)
...
def plot_MDS_of_trajectories(cfg):
    show = False
    save = True
