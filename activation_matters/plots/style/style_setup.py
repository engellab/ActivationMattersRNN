...
def set_up_plotting_styles(style_path):
    setup_fonts([os.path.join(style_path, "style", "assets", "fonts")], verbose=False)
    setup_colors([os.path.join(style_path, "style", "assets", "styles", "scientific.txt")], verbose=False)
    plt.style.use([os.path.join(style_path, "style", "assets", "styles", "scientific.mplstyle"), {'figure.dpi': 144}])
    return None